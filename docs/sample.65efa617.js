...
})({"k839P":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "74ab8fc465efa617";
"use strict";
...
},{}],"adngR":[function(require,module,exports) {
function updateDateTime() {
    const timeElement = document.getElementById("curr-time");
    const now = new Date();
    const options = {
        weekday: "long",
        year: "numeric",
...
//arts
const ARTS_API_URL = "https://api.nytimes.com/svc/topstories/v2/arts.json?api-key=nDxfsOEmrg52Bru3o9MXHqt6u9YShWgK"; //https://api.nytimes.com/svc/topstories/v2/arts.json?api-key=nDxfsOEmrg52Bru3o9MXHqt6u9YShWgK
//topstories_arts.json
...
const updateContainerarts = (arts)=>{
    ...
    (arts.results || []).forEach((arts_data)=>{
        ...
        const imageUrl = arts_data.multimedia && arts_data.multimedia.length > 0 ? arts_data.multimedia[0].url : "default-image-url.jpg";
...
//books
const BOOKS_API_URL = "https://api.nytimes.com/svc/books/v3/lists/current/hardcover-fiction.json?api-key=nDxfsOEmrg52Bru3o9MXHqt6u9YShWgK";
//books.json
...
const updateContainerbook = (book)=>{
    ...
    (book.results?.books || []).forEach((book_data)=>{
        ...
        <a href="${book_data.amazon_product_url}" target="_blank">About more</a>
      `;
...
// home
const API_URL = "https://api.nytimes.com/svc/topstories/v2/home.json?api-key=nDxfsOEmrg52Bru3o9MXHqt6u9YShWgK"; //https://api.nytimes.com/svc/topstories/v2/home.json?api-key=nDxfsOEmrg52Bru3o9MXHqt6u9YShWgK
//topstories_home.json
...
const updateSwiper = (data)=>{
    ...
    (data.results || []).forEach((news)=>{
        ...
        const imageUrl = news.multimedia && news.multimedia.length > 0 ? news.multimedia[0].url : "default-image-url.jpg";
        swiperSlide.innerHTML = `<a href="${news.url}" class="card-link" target="_blank">
...
},{}]},["k839P","adngR"], "adngR", "parcelRequire2b67")

//# sourceMappingURL=sample.65efa617.js.map
